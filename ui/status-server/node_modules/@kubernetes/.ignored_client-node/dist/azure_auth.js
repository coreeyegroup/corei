...
const json_path_1 = require("./json_path");
class AzureAuth {
    isAuthProvider(user) {
    ...
    updateAccessToken(config) {
        ...
        config['access-token'] = (0, json_path_1.jsonpath)(tokenPathKey, resultObj);
        config.expiry = (0, json_path_1.jsonpath)(expiryPathKey, resultObj);
    }
}
