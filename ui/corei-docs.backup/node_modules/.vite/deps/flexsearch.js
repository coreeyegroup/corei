...
// ../../node_modules/.pnpm/flexsearch@0.7.43/node_modules/flexsearch/dist/flexsearch.bundle.module.min.js
var t;
function u(a) {
...
var za = [J("[àáâãäå]"), "a", J("[èéêë]"), "e", J("[ìíîï]"), "i", J("[òóôõöő]"), "o", J("[ùúûüű]"), "u", J("[ýŷÿ]"), "y", J("ñ"), "n", J("[çc]"), "k", J("ß"), "s", J(" & "), " and "];
function xa(a) {
  var b = a = "" + a;
...
var Ca = /[^a-z0-9]+/;
var Da = { b: "p", v: "f", w: "f", z: "s", x: "s", "ß": "s", d: "t", n: "m", c: "k", g: "k", j: "k", q: "k", i: "e", y: "e", u: "o" };
function Aa(a) {
