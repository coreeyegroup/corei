...
declare type IncrementalIdCompat = number | boolean;
...
declare function assignProps<TSrc extends Dictionary<any>, TCommonKey extends keyof TSrc>(tar: NullUndefined, src: TSrc, props: readonly TCommonKey[]): Pick<TSrc, TCommonKey>;
declare function assignProps<TTar extends Dictionary<any>, TSrc extends Dictionary<any>, TCommonKey extends keyof TSrc & keyof TTar>(tar: TTar, src: TSrc & {
...
declare const util_d_assignProps: typeof assignProps;
...
declare namespace util_d {
  export {
    ...
    util_d_assignProps as assignProps,
...
declare class BoundingRect {
    ...
    static calculateTransform(out: MatrixArray | NullUndefined, a: RectLike, b: RectLike): MatrixArray;
}
...
declare type InHoverLayerKind = typeof IN_HOVER_LAYER_KIND_NO | typeof IN_HOVER_LAYER_KIND_ONLY_STYLE_CHANGE;
declare const IN_HOVER_LAYER_KIND_NO = 0;
declare const IN_HOVER_LAYER_KIND_ONLY_STYLE_CHANGE = 1;
...
declare type CanvasPainterRefreshOpt = {
    paintAll?: boolean;
    refresh?: boolean;
...
declare type AxisScaleType = 'ordinal' | 'interval' | 'log' | 'time';
interface AxisBaseOptionCommon extends ComponentOption, AnimationOptionMixin {
    ...
    min?: ScaleDataValue | 'dataMin' | ((extent: {
        min: number;
        max: number;
    }) => ScaleDataValue | NullUndefined$1);
    /**
...
declare type NumericAxisBoundaryGapOptionItemValue = number | string | NullUndefined$1;
...
declare type AxisTickOptionUnion = AxisBaseOptionCommon['axisTick'] | CategoryAxisBaseOption['axisTick'];
...
declare type AxisShowMinMaxLabelOption = boolean | NullUndefined$1;
declare type AxisTickLabelCustomValuesOption = (number | string | Date)[];
 ...
 */
declare type CategoryTickLabelSplitIntervalOption = 'auto' | number | CategoryTickLabelSplitIntervalCb | NullUndefined$1;
declare type CategoryTickLabelSplitIntervalCb = (linearTickValue: number, // tick value before sorted. "sort" means `OrdinalScale['setSortInfo']`.
rawLabel: string) => boolean;
declare type CategoryTickLabelSplitBuildingOption = {
    show?: boolean;
    interval?: CategoryTickLabelSplitIntervalOption;
};
...
interface GridOption extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, ShadowOptionMixin {
    mainType?: 'grid';
    show?: boolean;
    /**
...
declare type AxisBandWidthResult = {
    w: number;
    w2: number;
};
...
declare type BarGridLayoutResultForCustomSeries = BarGridLayoutResultItem[] | NullUndefined$1;
...
declare const AXIS_EXTENT_INFO_BUILD_FROM_COORD_SYS_UPDATE = 1;
declare const AXIS_EXTENT_INFO_BUILD_FROM_DATA_ZOOM = 2;
declare const AXIS_EXTENT_INFO_BUILD_FROM_EMPTY = 3;
declare type AxisExtentInfoBuildFrom = typeof AXIS_EXTENT_INFO_BUILD_FROM_COORD_SYS_UPDATE | typeof AXIS_EXTENT_INFO_BUILD_FROM_DATA_ZOOM | typeof AXIS_EXTENT_INFO_BUILD_FROM_EMPTY;
/**
 ...
 */
declare type ScaleExtentFixMinMax = boolean[];
/**
 * Return the min max before `dataZoom` applied.
 * This is `noZoomEffMM`, corresponding to `SCALE_EXTENT_KIND_EFFECTIVE`.
 */
declare type ScaleRawExtentResultForZoom = number[];
declare type ScaleRawExtentResultFinal = Pick<ScaleRawExtentInternal, 'fixMM' | 'zoomFixMM' | 'isBlank' | 'incl0' | 'tggAxInv' | 'ctnShp'> & {
    effMM: number[];
};
...
interface ScaleRawExtentInternal {
    ...
    noZoomEffMM: number[];
    dataMM: number[];
    zoomMM: (number | NullUndefined$1)[];
    fixMM: ScaleExtentFixMinMax;
    zoomFixMM: ScaleExtentFixMinMax;
    startValue: number | NullUndefined$1;
    isBlank: boolean;
    incl0: boolean;
    tggAxInv: boolean;
    ctnShp: boolean;
...
declare class ScaleRawExtentInfo {
     ...
     */
    setZoomMM(idxMinMax: 0 | 1, val: number | NullUndefined$1): void;
}

declare type DataSanitizationFilter = {
    g?: number;
    ge?: number;
    l?: number;
    le?: number;
 ...
 */
declare type ScaleExtentKind = typeof SCALE_EXTENT_KIND_EFFECTIVE | typeof SCALE_EXTENT_KIND_MAPPING;
declare const SCALE_EXTENT_KIND_EFFECTIVE = 0;
declare const SCALE_EXTENT_KIND_MAPPING = 1;
/**
 ...
 */
declare type ScaleMapperDepthOpt = {
    depth?: NullUndefined$1 | typeof SCALE_MAPPER_DEPTH_OUT_OF_BREAK | typeof SCALE_MAPPER_DEPTH_INNERMOST;
};
declare const SCALE_MAPPER_DEPTH_OUT_OF_BREAK = 2;
declare const SCALE_MAPPER_DEPTH_INNERMOST = 3;
declare type ScaleMapperTransformOutOpt = (ScaleMapperDepthOpt & ValueTransformLookupOpt);
declare type ScaleMapperTransformInOpt = ScaleMapperDepthOpt;
/**
 ...
 *
 */
interface ScaleMapper extends ScaleMapperGeneric<ScaleMapper> {
}
interface ScaleMapperGeneric<This> {
    /**
     ...
     */
    transformIn: (this: This, val: number, opt: ScaleMapperTransformInOpt | NullUndefined$1) => number;
    /**
     * [NOTICE]:
     *  - This method must be available since the instance is constructed.
     *  - This method has nothing to do with extent - transforming out of extent is supported.
     ...
     */
    transformOut: (this: This, val: number, opt: ScaleMapperTransformOutOpt | NullUndefined$1) => number;
    /**
     ...
     * @see SCALE_EXTENT_CONSTRUCTION for the full processing flow.
     */
    getExtentUnsafe(this: This, kind: ScaleExtentKind, depth: ScaleMapperDepthOpt['depth'] | NullUndefined$1): number[] | NullUndefined$1;
    /**
     * [NOTICE]:
     ...
     */
    sanitize?: ((this: This, value: number | NullUndefined$1, dataExtent: number[]) => number | NullUndefined$1) | NullUndefined$1;
    /**
     * If not provided, use `0`.
     */
    getDefaultStartValue?: (() => number) | NullUndefined$1;
    /**
 ...
 */
declare type ValueTransformLookupOpt = {
    lookup?: {
        from: number[];
        to: number[];
    } | NullUndefined$1;
 ...
 */
interface BreakScaleMapper extends ScaleMapper {
...
declare abstract class Scale<This = unknown> {
     ...
     */
    readonly brk: BreakScaleMapper | NullUndefined$1;
    private _isBlank;
    readonly rawExtentInfo: ScaleRawExtentInfo | NullUndefined$1;
    /**
...
declare class Axis {
    ...
    __alignTo: Axis | NullUndefined$1;
...
interface LegendOption extends ComponentOption, LegendStyleOption, BoxLayoutOptionMixin, BorderOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    mainType?: 'legend';
    show?: boolean;
    orient?: LayoutOrient;
...
interface MapSeriesOption extends SeriesOption<MapStateOption<CallbackDataParams>, StatesMixinBase>, MapStateOption<CallbackDataParams>, GeoCommonOptionMixin, SeriesOnGeoOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, SeriesEncodeOptionMixin {
    type?: 'map';
...
interface GeoOption extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, AnimationOptionMixin, GeoCommonOptionMixin, StatesOptionMixin<GeoStateOption, StatesMixinBase>, GeoStateOption {
    mainType?: 'geo';
    show?: boolean;
    silent?: boolean;
...
declare class DataStore {
    ...
    getDataExtent(dim: DimensionIndex, filter: DataSanitizationFilter | NullUndefined$1): [number, number];
    /**
     * Get raw data index.
     * Do not initialize.
...
interface VisualMapOption<T extends VisualOptionBase = VisualOptionBase> extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, BorderOptionMixin {
    mainType?: 'visualMap';
    show?: boolean;
    align?: string;
    realtime?: boolean;
 ...
 */
declare type ModelFinderIndexQuery = number | number[] | 'all' | 'none' | false | NullUndefined$1;
declare type ModelFinderIdQuery = OptionId | OptionId[] | NullUndefined$1;
declare type ModelFinderNameQuery = OptionId | OptionId[] | NullUndefined$1;
...
interface ScaleTick {
    ...
    time?: TimeScaleTick['time'];
    notNice?: boolean | NullUndefined$1;
    offInterval?: boolean | NullUndefined$1;
}
...
interface SeriesOnRadarOptionMixin {
    radarIndex?: number;
    radarId?: OptionId;
}
interface ComponentOnCalendarOptionMixin {
    calendarIndex?: number;
    calendarId?: OptionId;
}
interface ComponentOnMatrixOptionMixin {
    matrixIndex?: number;
    matrixId?: OptionId;
}
...
declare type ECUpdateMethodName = (keyof typeof updateMethods) | 'none';
 ...
 */
declare function createScale(dataExtent: number[], option: object | AxisBaseModel): Scale<unknown>;
/**
...
declare function roundLegacy(x: number | string, precision?: number): number;
declare function roundLegacy(x: number | string, precision: number, returnStr: false): number;
declare function roundLegacy(x: number | string, precision: number, returnStr: true): string;
/**
...
declare const NICE_MODE_ROUND: 1;
declare const NICE_MODE_MIN: 2;
/**
 ...
 * @return Niced number
 */
declare function nice(val: number, mode?: boolean | typeof NICE_MODE_ROUND | typeof NICE_MODE_MIN): number;
/**
...
interface PolarOption extends ComponentOption, CircleLayoutOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    mainType?: 'polar';
}
...
interface ParallelCoordinateSystemOption extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin {
    mainType?: 'parallel';
...
interface RadarOption extends ComponentOption, CircleLayoutOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    mainType?: 'radar';
    startAngle?: number;
    clockwise?: boolean;
...
interface MatrixLabelOption extends LabelOption {
    formatter?: string | ((params: MatrixLabelFormatterParams) => string);
}
interface MatrixLabelFormatterParams {
...
interface ToolboxOption extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, BorderOptionMixin {
    mainType?: 'toolbox';
    show?: boolean;
    orient?: LayoutOrient;
    backgroundColor?: ZRColor;
...
interface TitleOption extends ComponentOption, BoxLayoutOptionMixin, BorderOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    mainType?: 'title';
    show?: boolean;
    text?: string;
    /**
 ...
 */
interface ThumbnailOption extends ComponentOption, BoxLayoutOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    mainType?: 'thumbnail';
    show?: boolean;
    itemStyle?: ItemStyleOption;
...
interface TimelineOption extends ComponentOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, SymbolOptionMixin {
    mainType?: 'timeline';
    backgroundColor?: ZRColor;
    borderColor?: ColorString;
    borderWidth?: number;
...
interface SliderDataZoomOption extends DataZoomOption, BoxLayoutOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin {
    show?: boolean;
    /**
...
interface ContinuousVisualMapOption extends VisualMapOption {
...
interface PieSeriesOption extends Omit<SeriesOption<PieStateOption<PieCallbackDataParams>, ExtraStateOption>, 'labelLine'>, PieStateOption<PieCallbackDataParams>, CircleLayoutOptionMixin<{
...
interface RadarSeriesOption extends SeriesOption<RadarSeriesStateOption, RadarStatesMixin>, RadarSeriesStateOption, SeriesOnRadarOptionMixin, SymbolOptionMixin<CallbackDataParams>, SeriesEncodeOptionMixin {
    type?: 'radar';
...
interface TreeSeriesOption extends SeriesOption<TreeSeriesStateOption, TreeStatesMixin>, TreeSeriesStateOption, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, SymbolOptionMixin<CallbackDataParams>, BoxLayoutOptionMixin, RoamOptionMixin {
    type?: 'tree';
...
interface TreemapSeriesOption extends SeriesOption<TreemapStateOption<TreemapSeriesCallbackDataParams>, ExtraStateOption$1>, TreemapStateOption<TreemapSeriesCallbackDataParams>, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, RoamOptionMixin, TreemapSeriesVisualOption {
    type?: 'treemap';
    /**
...
interface GaugeSeriesOption extends SeriesOption<GaugeStateOption, GaugeStatesMixin>, GaugeStateOption<CallbackDataParams>, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, CircleLayoutOptionMixin, SeriesEncodeOptionMixin {
    type?: 'gauge';
...
interface FunnelSeriesOption extends SeriesOption<FunnelStateOption<FunnelCallbackDataParams>, FunnelStatesMixin>, FunnelStateOption<FunnelCallbackDataParams>, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, BoxLayoutOptionMixin, SeriesEncodeOptionMixin {
    type?: 'funnel';
    min?: number;
    max?: number;
    /**
...
interface ParallelSeriesOption extends SeriesOption<ParallelStateOption<CallbackDataParams>, ParallelStatesMixin>, ParallelStateOption<CallbackDataParams>, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, SeriesEncodeOptionMixin {
    type?: 'parallel';
    coordinateSystem?: string;
    parallelIndex?: number;
    parallelId?: string;
...
interface SankeySeriesOption extends SeriesOption<SankeyBothStateOption<CallbackDataParams>, ExtraStateOption$2>, SankeyBothStateOption<CallbackDataParams>, BoxLayoutOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, RoamOptionMixin {
    type?: 'sankey';
    /**
...
interface LinesSeriesOption extends SeriesOption<LinesStateOption, LinesStatesMixin>, LinesStateOption<CallbackDataParams>, SeriesOnCartesianOptionMixin, SeriesOnGeoOptionMixin, SeriesOnPolarOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, SeriesLargeOptionMixin {
    type?: 'lines';
    coordinateSystem?: string;
    symbol?: string[] | string;
    symbolSize?: number[] | number;
...
interface HeatmapSeriesOption extends SeriesOption<HeatmapStateOption<CallbackDataParams>, HeatmapStatesMixin>, HeatmapStateOption<CallbackDataParams>, SeriesOnCartesianOptionMixin, SeriesOnGeoOptionMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, SeriesEncodeOptionMixin {
    type?: 'heatmap';
...
interface SunburstSeriesOption extends SeriesOption<SunburstStateOption<SunburstDataParams>, SunburstStatesMixin>, SunburstStateOption<SunburstDataParams>, SunburstColorByMixin, ComponentOnCalendarOptionMixin, ComponentOnMatrixOptionMixin, CircleLayoutOptionMixin {
    type?: 'sunburst';
    clockwise?: boolean;
    startAngle?: number;
    minAngle?: number;
 ...
 */
declare type ContinousVisualMapComponentOption = ContinuousVisualMapOption;
declare type VisualMapComponentOption = ContinuousVisualMapOption | PiecewiseVisualMapOption;
...
type echarts__ECUMDEXPT___AnimationDelayCallback = AnimationDelayCallback;
type echarts__ECUMDEXPT___AnimationDurationCallback = AnimationDurationCallback;
type echarts__ECUMDEXPT___Axis = Axis;
declare const echarts__ECUMDEXPT___Axis: typeof Axis;
type echarts__ECUMDEXPT___AxisBreakChangedEvent = AxisBreakChangedEvent;
type echarts__ECUMDEXPT___ChartView = ChartView;
declare const echarts__ECUMDEXPT___ChartView: typeof ChartView;
type echarts__ECUMDEXPT___CollapseAxisBreakPayload = CollapseAxisBreakPayload;
type echarts__ECUMDEXPT___ComponentModel<Opt extends ComponentOption = ComponentOption> = ComponentModel<Opt>;
declare const echarts__ECUMDEXPT___ComponentModel: typeof ComponentModel;
type echarts__ECUMDEXPT___ComponentView = ComponentView;
declare const echarts__ECUMDEXPT___ComponentView: typeof ComponentView;
type echarts__ECUMDEXPT___ComposeOption<OptionUnion extends ComponentOption> = ComposeOption<OptionUnion>;
type echarts__ECUMDEXPT___ContinousVisualMapComponentOption = ContinousVisualMapComponentOption;
type echarts__ECUMDEXPT___CustomSeriesRenderItem = CustomSeriesRenderItem;
type echarts__ECUMDEXPT___CustomSeriesRenderItemAPI = CustomSeriesRenderItemAPI;
type echarts__ECUMDEXPT___CustomSeriesRenderItemParams = CustomSeriesRenderItemParams;
type echarts__ECUMDEXPT___CustomSeriesRenderItemReturn = CustomSeriesRenderItemReturn;
type echarts__ECUMDEXPT___DataZoomComponentOption = DataZoomComponentOption;
type echarts__ECUMDEXPT___DownplayPayload = DownplayPayload;
type echarts__ECUMDEXPT___ECElementEvent = ECElementEvent;
type echarts__ECUMDEXPT___ECUpdateMethodName = ECUpdateMethodName;
type echarts__ECUMDEXPT___EChartsInitOpts = EChartsInitOpts;
type echarts__ECUMDEXPT___EChartsOption = EChartsOption;
type echarts__ECUMDEXPT___EChartsType = EChartsType;
type echarts__ECUMDEXPT___ElementEvent = ElementEvent;
type echarts__ECUMDEXPT___ExpandAxisBreakPayload = ExpandAxisBreakPayload;
type echarts__ECUMDEXPT___HighlightPayload = HighlightPayload;
type echarts__ECUMDEXPT___ImagePatternObject = ImagePatternObject;
type echarts__ECUMDEXPT___LabelFormatterCallback<T = CallbackDataParams> = LabelFormatterCallback<T>;
type echarts__ECUMDEXPT___LabelLayoutOptionCallback = LabelLayoutOptionCallback;
type echarts__ECUMDEXPT___LabelLayoutOptionCallbackParams = LabelLayoutOptionCallbackParams;
type echarts__ECUMDEXPT___LegendComponentOption = LegendComponentOption;
type echarts__ECUMDEXPT___LinearGradientObject = LinearGradientObject;
type echarts__ECUMDEXPT___Model<Opt = ModelOption> = Model<Opt>;
declare const echarts__ECUMDEXPT___Model: typeof Model;
declare const echarts__ECUMDEXPT___PRIORITY: typeof PRIORITY;
type echarts__ECUMDEXPT___PatternObject = PatternObject;
type echarts__ECUMDEXPT___Payload = Payload;
type echarts__ECUMDEXPT___RadialGradientObject = RadialGradientObject;
type echarts__ECUMDEXPT___RegisteredSeriesOption = RegisteredSeriesOption;
type echarts__ECUMDEXPT___ResizeOpts = ResizeOpts;
type echarts__ECUMDEXPT___SVGPatternObject = SVGPatternObject;
type echarts__ECUMDEXPT___SelectChangedEvent = SelectChangedEvent;
type echarts__ECUMDEXPT___SelectChangedPayload = SelectChangedPayload;
type echarts__ECUMDEXPT___SeriesModel<Opt extends SeriesOption = SeriesOption> = SeriesModel<Opt>;
type echarts__ECUMDEXPT___SetOptionOpts = SetOptionOpts;
type echarts__ECUMDEXPT___SetOptionTransitionOpt = SetOptionTransitionOpt;
type echarts__ECUMDEXPT___SetOptionTransitionOptItem = SetOptionTransitionOptItem;
type echarts__ECUMDEXPT___SetThemeOpts = SetThemeOpts;
type echarts__ECUMDEXPT___ToggleAxisBreakPayload = ToggleAxisBreakPayload;
type echarts__ECUMDEXPT___ToolboxComponentOption = ToolboxComponentOption;
type echarts__ECUMDEXPT___VisualMapComponentOption = VisualMapComponentOption;
declare const echarts__ECUMDEXPT___connect: typeof connect;
declare const echarts__ECUMDEXPT___dataTool: typeof dataTool;
declare const echarts__ECUMDEXPT___dependencies: typeof dependencies;
declare const echarts__ECUMDEXPT___disConnect: typeof disConnect;
declare const echarts__ECUMDEXPT___disconnect: typeof disconnect;
declare const echarts__ECUMDEXPT___env: typeof env;
declare const echarts__ECUMDEXPT___extendChartView: typeof extendChartView;
declare const echarts__ECUMDEXPT___extendComponentModel: typeof extendComponentModel;
declare const echarts__ECUMDEXPT___extendComponentView: typeof extendComponentView;
declare const echarts__ECUMDEXPT___extendSeriesModel: typeof extendSeriesModel;
declare const echarts__ECUMDEXPT___getCoordinateSystemDimensions: typeof getCoordinateSystemDimensions;
declare const echarts__ECUMDEXPT___getInstanceByDom: typeof getInstanceByDom;
declare const echarts__ECUMDEXPT___getInstanceById: typeof getInstanceById;
declare const echarts__ECUMDEXPT___getMap: typeof getMap;
declare const echarts__ECUMDEXPT___parseGeoJSON: typeof parseGeoJSON;
declare const echarts__ECUMDEXPT___registerAction: typeof registerAction;
declare const echarts__ECUMDEXPT___registerCoordinateSystem: typeof registerCoordinateSystem;
declare const echarts__ECUMDEXPT___registerCustomSeries: typeof registerCustomSeries;
declare const echarts__ECUMDEXPT___registerLayout: typeof registerLayout;
declare const echarts__ECUMDEXPT___registerLoading: typeof registerLoading;
declare const echarts__ECUMDEXPT___registerLocale: typeof registerLocale;
declare const echarts__ECUMDEXPT___registerMap: typeof registerMap;
declare const echarts__ECUMDEXPT___registerPostInit: typeof registerPostInit;
declare const echarts__ECUMDEXPT___registerPostUpdate: typeof registerPostUpdate;
declare const echarts__ECUMDEXPT___registerPreprocessor: typeof registerPreprocessor;
declare const echarts__ECUMDEXPT___registerProcessor: typeof registerProcessor;
declare const echarts__ECUMDEXPT___registerTheme: typeof registerTheme;
declare const echarts__ECUMDEXPT___registerTransform: typeof registerTransform;
declare const echarts__ECUMDEXPT___registerUpdateLifecycle: typeof registerUpdateLifecycle;
declare const echarts__ECUMDEXPT___registerVisual: typeof registerVisual;
declare const echarts__ECUMDEXPT___setCanvasCreator: typeof setCanvasCreator;
declare const echarts__ECUMDEXPT___setPlatformAPI: typeof setPlatformAPI;
declare const echarts__ECUMDEXPT___throttle: typeof throttle;
declare const echarts__ECUMDEXPT___use: typeof use;
declare namespace echarts__ECUMDEXPT__ {
  export {
    AngleAxisOption as AngleAxisComponentOption,
    echarts__ECUMDEXPT___AnimationDelayCallback as AnimationDelayCallback,
    AnimationDelayCallbackParam as AnimationDelayCallbackParams,
    echarts__ECUMDEXPT___AnimationDurationCallback as AnimationDurationCallback,
    AriaOption as AriaComponentOption,
    echarts__ECUMDEXPT___Axis as Axis,
    echarts__ECUMDEXPT___AxisBreakChangedEvent as AxisBreakChangedEvent,
    ...
    echarts__ECUMDEXPT___ChartView as ChartView,
    ChordSeriesOption$1 as ChordSeriesOption,
    echarts__ECUMDEXPT___CollapseAxisBreakPayload as CollapseAxisBreakPayload,
    ZRColor as Color,
    echarts__ECUMDEXPT___ComponentModel as ComponentModel,
    echarts__ECUMDEXPT___ComponentView as ComponentView,
    echarts__ECUMDEXPT___ComposeOption as ComposeOption,
    echarts__ECUMDEXPT___ContinousVisualMapComponentOption as ContinousVisualMapComponentOption,
    ContinuousVisualMapOption as ContinuousVisualMapComponentOption,
    CustomSeriesOption$1 as CustomSeriesOption,
    echarts__ECUMDEXPT___CustomSeriesRenderItem as CustomSeriesRenderItem,
    echarts__ECUMDEXPT___CustomSeriesRenderItemAPI as CustomSeriesRenderItemAPI,
    echarts__ECUMDEXPT___CustomSeriesRenderItemParams as CustomSeriesRenderItemParams,
    echarts__ECUMDEXPT___CustomSeriesRenderItemReturn as CustomSeriesRenderItemReturn,
    echarts__ECUMDEXPT___DataZoomComponentOption as DataZoomComponentOption,
    DatasetOption as DatasetComponentOption,
    CallbackDataParams as DefaultLabelFormatterCallbackParams,
    echarts__ECUMDEXPT___DownplayPayload as DownplayPayload,
    echarts__ECUMDEXPT___ECElementEvent as ECElementEvent,
    echarts__ECUMDEXPT___ECUpdateMethodName as ECUpdateMethodName,
    EChartsType as ECharts,
    ECBasicOption as EChartsCoreOption,
    echarts__ECUMDEXPT___EChartsInitOpts as EChartsInitOpts,
    echarts__ECUMDEXPT___EChartsOption as EChartsOption,
    echarts__ECUMDEXPT___EChartsType as EChartsType,
    EffectScatterSeriesOption$1 as EffectScatterSeriesOption,
    echarts__ECUMDEXPT___ElementEvent as ElementEvent,
    echarts__ECUMDEXPT___ExpandAxisBreakPayload as ExpandAxisBreakPayload,
    ...
    echarts__ECUMDEXPT___HighlightPayload as HighlightPayload,
    echarts__ECUMDEXPT___ImagePatternObject as ImagePatternObject,
    InsideDataZoomOption as InsideDataZoomComponentOption,
    echarts__ECUMDEXPT___LabelFormatterCallback as LabelFormatterCallback,
    echarts__ECUMDEXPT___LabelLayoutOptionCallback as LabelLayoutOptionCallback,
    echarts__ECUMDEXPT___LabelLayoutOptionCallbackParams as LabelLayoutOptionCallbackParams,
    echarts__ECUMDEXPT___LegendComponentOption as LegendComponentOption,
    LineSeriesOption$1 as LineSeriesOption,
    echarts__ECUMDEXPT___LinearGradientObject as LinearGradientObject,
    ...
    MatrixOption as MatrixComponentOption,
    echarts__ECUMDEXPT___Model as Model,
    echarts__ECUMDEXPT___PRIORITY as PRIORITY,
    ParallelCoordinateSystemOption as ParallelComponentOption,
    ParallelSeriesOption$1 as ParallelSeriesOption,
    echarts__ECUMDEXPT___PatternObject as PatternObject,
    echarts__ECUMDEXPT___Payload as Payload,
    ...
    echarts__ECUMDEXPT___RadialGradientObject as RadialGradientObject,
    RadiusAxisOption as RadiusAxisComponentOption,
    echarts__ECUMDEXPT___RegisteredSeriesOption as RegisteredSeriesOption,
    echarts__ECUMDEXPT___ResizeOpts as ResizeOpts,
    echarts__ECUMDEXPT___SVGPatternObject as SVGPatternObject,
    ...
    echarts__ECUMDEXPT___SelectChangedEvent as SelectChangedEvent,
    echarts__ECUMDEXPT___SelectChangedPayload as SelectChangedPayload,
    echarts__ECUMDEXPT___SeriesModel as SeriesModel,
    SeriesOption$1 as SeriesOption,
    echarts__ECUMDEXPT___SetOptionOpts as SetOptionOpts,
    echarts__ECUMDEXPT___SetOptionTransitionOpt as SetOptionTransitionOpt,
    echarts__ECUMDEXPT___SetOptionTransitionOptItem as SetOptionTransitionOptItem,
    echarts__ECUMDEXPT___SetThemeOpts as SetThemeOpts,
    ...
    ThumbnailOption as ThumbnailComponentOption,
    TimelineOption as TimelineComponentOption,
    TitleOption as TitleComponentOption,
    echarts__ECUMDEXPT___ToggleAxisBreakPayload as ToggleAxisBreakPayload,
    echarts__ECUMDEXPT___ToolboxComponentOption as ToolboxComponentOption,
    ...
    echarts__ECUMDEXPT___VisualMapComponentOption as VisualMapComponentOption,
    XAXisOption as XAXisComponentOption,
    XAXisOption as XAxisComponentOption,
    YAXisOption as YAXisComponentOption,
    YAXisOption as YAxisComponentOption,
    color_d as color,
    echarts__ECUMDEXPT___connect as connect,
    echarts__ECUMDEXPT___dataTool as dataTool,
    echarts__ECUMDEXPT___dependencies as dependencies,
    echarts__ECUMDEXPT___disConnect as disConnect,
    echarts__ECUMDEXPT___disconnect as disconnect,
    dispose$1 as dispose,
    echarts__ECUMDEXPT___env as env,
    echarts__ECUMDEXPT___extendChartView as extendChartView,
    echarts__ECUMDEXPT___extendComponentModel as extendComponentModel,
    echarts__ECUMDEXPT___extendComponentView as extendComponentView,
    echarts__ECUMDEXPT___extendSeriesModel as extendSeriesModel,
    format_d as format,
    echarts__ECUMDEXPT___getCoordinateSystemDimensions as getCoordinateSystemDimensions,
    echarts__ECUMDEXPT___getInstanceByDom as getInstanceByDom,
    echarts__ECUMDEXPT___getInstanceById as getInstanceById,
    echarts__ECUMDEXPT___getMap as getMap,
    ...
    matrix_d as matrix,
    number_d as number,
    echarts__ECUMDEXPT___parseGeoJSON as parseGeoJSON,
    parseGeoJSON as parseGeoJson,
    echarts__ECUMDEXPT___registerAction as registerAction,
    echarts__ECUMDEXPT___registerCoordinateSystem as registerCoordinateSystem,
    echarts__ECUMDEXPT___registerCustomSeries as registerCustomSeries,
    echarts__ECUMDEXPT___registerLayout as registerLayout,
    echarts__ECUMDEXPT___registerLoading as registerLoading,
    echarts__ECUMDEXPT___registerLocale as registerLocale,
    echarts__ECUMDEXPT___registerMap as registerMap,
    echarts__ECUMDEXPT___registerPostInit as registerPostInit,
    echarts__ECUMDEXPT___registerPostUpdate as registerPostUpdate,
    echarts__ECUMDEXPT___registerPreprocessor as registerPreprocessor,
    echarts__ECUMDEXPT___registerProcessor as registerProcessor,
    echarts__ECUMDEXPT___registerTheme as registerTheme,
    echarts__ECUMDEXPT___registerTransform as registerTransform,
    echarts__ECUMDEXPT___registerUpdateLifecycle as registerUpdateLifecycle,
    echarts__ECUMDEXPT___registerVisual as registerVisual,
    echarts__ECUMDEXPT___setCanvasCreator as setCanvasCreator,
    echarts__ECUMDEXPT___setPlatformAPI as setPlatformAPI,
    echarts__ECUMDEXPT___throttle as throttle,
    time_d as time,
    echarts__ECUMDEXPT___use as use,
    util_d$1 as util,
    vector_d as vector,
