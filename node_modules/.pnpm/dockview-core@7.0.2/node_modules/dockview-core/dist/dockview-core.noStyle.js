...
(function (global, factory) {
    ...
    class BaseGrid extends Resizable {
        ...
        doAddGroup(group, location = [0], size, gridview = this.gridview) {
            gridview.addView(group, size !== null && size !== void 0 ? size : exports.Sizing.Distribute, location);
    ...
    class ContentContainer extends CompositeDisposable {
        ...
        constructor(accessor, group) {
            ...
            })) !== null && _g !== void 0 ? _g : exports.DockviewDisposable.NONE);
        }
        show() {
    ...
    const WatermarkModule = defineModule({
        ...
        init: (host, service) => {
            ...
            service.update();
            return new CompositeDisposable(exports.DockviewEvent.any(host.onDidAdd, host.onDidRemove)(() => {
                service.update();
    ...
    class RootDropTargetService {
        constructor(host) {
            ...
            this.onWillShowOverlay = exports.DockviewEvent.any(this._html5Target.onWillShowOverlay, this._pointerTarget.onWillShowOverlay);
            this.onDrop = exports.DockviewEvent.any(this._html5Target.onDrop, this._pointerTarget.onDrop);
    ...
    ***************************************************************************** */
    ...
    class DockviewComponent extends BaseGrid {
        ...
        showDropPreview(group, position) {
            var _a, _b;
            return ((_b = (_a = this._advancedDnDService) === null || _a === void 0 ? void 0 : _a.showPreviewOverlay(group, position)) !== null && _b !== void 0 ? _b : exports.DockviewDisposable.NONE);
        }
        announce(message) {
            var _a;
        ...
        constructor(container, options) {
            ...
            }), exports.DockviewEvent.any(this.onDidAddPanel, this.onDidRemovePanel, this.onDidAddGroup, this.onDidRemove, this.onDidRemoveGroup, this.onDidMovePanel, this.onDidActivePanelChange)(() => {
                this._bufferOnDidLayoutChange.fire();
            }), exports.DockviewDisposable.from(() => {
                var _a;
        ...
        _doAddPopoutGroup(itemToPopout, options) {
            ...
            return _window
                ...
                if (!(options === null || options === void 0 ? void 0 : options.overridePopoutGridview)) {
                    popoutGridview.addView(group, exports.Sizing.Distribute, [0]);
                }
                ...
                popoutWindowDisposable.addDisposables(_onDidWindowPositionChange, onDidWindowResizeEnd(_window.window, () => {
                    ...
                    popoutGridview.layout(_window.window.innerWidth, _window.window.innerHeight);
                }), overlayRenderContainer, exports.DockviewDisposable.from(() => this.disposePopoutWindow({
                    group,
                    referenceGroup,
                    popoutGridview,
                    isGroupAddedToDom,
        ...
        _doAddFloatingGroup(item, options) {
            ...
            floatingGridview.addView(group, exports.Sizing.Distribute, [0]);
         ...
         */
        createNestedGridview(orientation = exports.Orientation.HORIZONTAL) {
            var _a, _b;
        ...
        mountFloatingWindow(floatingGridview, anchorGroup, members, anchoredBox, options) {
            ...
            if (titleBar) {
                ...
                floatingGroupPanel.addDisposables(titleBar, exports.DockviewDisposable.from(() => floatingGroupPanel.setTitleBar(undefined)), titleBar.onDragStart((event) => {
