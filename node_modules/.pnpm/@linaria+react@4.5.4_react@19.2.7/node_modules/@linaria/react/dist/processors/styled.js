...
var StyledProcessor = class extends import_tags.TaggedTemplateProcessor {
        ...
        if ((_a = value.importedFrom) == null ? void 0 : _a.length) {
          ...
          const isSomeMatched = value.importedFrom.some((importedFrom) => {
            ...
            if (importedPkg) {
              ...
              let mask = (_a2 = packageJSON == null ? void 0 : packageJSON.linaria) == null ? void 0 : _a2.components;
  ...
  extractRules(valueCache, cssText, loc) {
    ...
    while ((0, import_utils.hasMeta)(value)) {
