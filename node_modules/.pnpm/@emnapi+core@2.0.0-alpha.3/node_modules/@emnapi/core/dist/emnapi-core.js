...
function createNapiModule (options) {
  var napiModule = (function () {
    ...
    function convertJsFunctionToWasm(func, sig) {
        if (_WebAssembly.Function) {
            return new _WebAssembly.Function(sigToWasmTypes(sig), func);
        }
        ...
        const module = new _WebAssembly.Module(bytes);
        const instance = new _WebAssembly.Instance(module, { e: { f: func } });
