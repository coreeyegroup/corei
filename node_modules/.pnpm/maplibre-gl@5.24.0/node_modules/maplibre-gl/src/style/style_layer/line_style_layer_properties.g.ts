...
const getLayout = () => layout = layout || new Properties({
    "line-cap": new DataDrivenProperty(styleSpec["layout_line"]["line-cap"] as any as StylePropertySpecification),
    "line-join": new DataDrivenProperty(styleSpec["layout_line"]["line-join"] as any as StylePropertySpecification),
    "line-miter-limit": new DataDrivenProperty(styleSpec["layout_line"]["line-miter-limit"] as any as StylePropertySpecification),
    "line-round-limit": new DataDrivenProperty(styleSpec["layout_line"]["line-round-limit"] as any as StylePropertySpecification),
