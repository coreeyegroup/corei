 ...
 */
type OneVar = OneVarConfig;
/**
 * Configuration accepted by the `one-var` rule.
 */
type OneVarConfig = OneVarMode | OneVarOptions;
/**
 * Controls how variable declarators are grouped into declarations.
 */
type OneVarMode = "always" | "never" | "consecutive";
...
type DirectiveConfigSchema = boolean | RequireDescription | DescriptionFormatConfig;
...
interface AnchorHasContentConfig {
  /**
...
interface NoWarningCommentsConfig {
  /**
...
interface DescriptionFormatConfig {
