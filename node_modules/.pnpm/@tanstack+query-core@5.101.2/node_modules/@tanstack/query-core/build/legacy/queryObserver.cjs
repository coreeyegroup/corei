...
var QueryObserver = class extends import_subscribable.Subscribable {
  ...
  setOptions(options) {
    ...
    if (this.options.enabled !== void 0 && typeof this.options.enabled !== "boolean" && typeof this.options.enabled !== "function" && typeof (0, import_utils.resolveQueryBoolean)(this.options.enabled, __privateGet(this, _currentQuery)) !== "boolean") {
      throw new Error(
    ...
    this.updateResult();
    if (mounted && (__privateGet(this, _currentQuery) !== prevQuery || (0, import_utils.resolveQueryBoolean)(this.options.enabled, __privateGet(this, _currentQuery)) !== (0, import_utils.resolveQueryBoolean)(prevOptions.enabled, __privateGet(this, _currentQuery)) || (0, import_utils.resolveStaleTime)(this.options.staleTime, __privateGet(this, _currentQuery)) !== (0, import_utils.resolveStaleTime)(prevOptions.staleTime, __privateGet(this, _currentQuery)))) {
      __privateMethod(this, _QueryObserver_instances, updateStaleTimeout_fn).call(this);
    }
    const nextRefetchInterval = __privateMethod(this, _QueryObserver_instances, computeRefetchInterval_fn).call(this);
    if (mounted && (__privateGet(this, _currentQuery) !== prevQuery || (0, import_utils.resolveQueryBoolean)(this.options.enabled, __privateGet(this, _currentQuery)) !== (0, import_utils.resolveQueryBoolean)(prevOptions.enabled, __privateGet(this, _currentQuery)) || nextRefetchInterval !== __privateGet(this, _currentRefetchInterval))) {
...
updateRefetchInterval_fn = function(nextInterval) {
  ...
  if (import_environmentManager.environmentManager.isServer() || (0, import_utils.resolveQueryBoolean)(this.options.enabled, __privateGet(this, _currentQuery)) === false || !(0, import_utils.isValidTimeout)(__privateGet(this, _currentRefetchInterval)) || __privateGet(this, _currentRefetchInterval) === 0) {
    return;
  }
