...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkHHGH3NKSjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
        ...
        Promise.resolve(payloadPromise).then(async (payload) => {
          if (payload.type === "redirect") {
            ...
            if (payload.reload || isExternalLocation(location2)) {
              if (_chunkHHGH3NKSjs.hasInvalidProtocol.call(void 0, location2)) {
...
function createRouterFromPayload({
  ...
  _chunk3UVS743Kjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkHHGH3NKSjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkHHGH3NKSjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunk3UVS743Kjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkHHGH3NKSjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkHHGH3NKSjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkHHGH3NKSjs.getSingleFetchDataStrategyImpl.call(void 0,
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunkHHGH3NKSjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunkHHGH3NKSjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkHHGH3NKSjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkHHGH3NKSjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkHHGH3NKSjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkHHGH3NKSjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkHHGH3NKSjs.setIsHydrated.call(void 0, );
  }, []);
  ...
  return /* @__PURE__ */ React3.createElement(_chunkHHGH3NKSjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunk3UVS743Kjs.RSCRouterGlobalErrorBoundary, { location: state.location }, /* @__PURE__ */ React3.createElement(_chunkHHGH3NKSjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkHHGH3NKSjs.RouterProvider,
    {
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkHHGH3NKSjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunk3UVS743Kjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkHHGH3NKSjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkHHGH3NKSjs.shouldHydrateRouteLoader.call(void 0,
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkHHGH3NKSjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkHHGH3NKSjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
async function fetchAndApplyManifestPatches(paths, createFromReadableStream, fetchImplementation, signal) {
  paths = _chunkHHGH3NKSjs.getPathsWithAncestors.call(void 0, paths);
...
function normalizeRedirectLocation(location2) {
  if (_chunkHHGH3NKSjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunkHHGH3NKSjs.resolvePath.call(void 0, location2);
