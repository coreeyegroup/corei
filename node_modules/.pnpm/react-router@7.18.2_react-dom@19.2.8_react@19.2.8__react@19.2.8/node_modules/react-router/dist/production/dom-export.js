...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkTP6EHSSFjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
        ...
        Promise.resolve(payloadPromise).then(async (payload) => {
          if (payload.type === "redirect") {
            ...
            if (payload.reload || isExternalLocation(location2)) {
              if (_chunkTP6EHSSFjs.hasInvalidProtocol.call(void 0, location2)) {
...
function createRouterFromPayload({
  ...
  _chunkVJZ67BZEjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkTP6EHSSFjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkTP6EHSSFjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkVJZ67BZEjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkTP6EHSSFjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkTP6EHSSFjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkTP6EHSSFjs.getSingleFetchDataStrategyImpl.call(void 0,
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunkTP6EHSSFjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunkTP6EHSSFjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkTP6EHSSFjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkTP6EHSSFjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkTP6EHSSFjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkTP6EHSSFjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkTP6EHSSFjs.setIsHydrated.call(void 0, );
  }, []);
  ...
  return /* @__PURE__ */ React3.createElement(_chunkTP6EHSSFjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkVJZ67BZEjs.RSCRouterGlobalErrorBoundary, { location: state.location }, /* @__PURE__ */ React3.createElement(_chunkTP6EHSSFjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkTP6EHSSFjs.RouterProvider,
    {
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkTP6EHSSFjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkVJZ67BZEjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkTP6EHSSFjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkTP6EHSSFjs.shouldHydrateRouteLoader.call(void 0,
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkTP6EHSSFjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkTP6EHSSFjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
async function fetchAndApplyManifestPatches(paths, createFromReadableStream, fetchImplementation, signal) {
  paths = _chunkTP6EHSSFjs.getPathsWithAncestors.call(void 0, paths);
...
function normalizeRedirectLocation(location2) {
  if (_chunkTP6EHSSFjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunkTP6EHSSFjs.resolvePath.call(void 0, location2);
